...
import ShareButton from "@/components/buttons/SharedButton";
...
export default function Home() {
  ...
  return (
    ...
    ${!rateLimit.canAnalyze ? "opacity-50 cursor-not-allowed" : ""}
  `}
                      >
                        <input
                          type="checkbox"
                  ...
                  {!errorMessage && rateLimit.canAnalyze && (
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          <span className="font-semibold">Tip:</span> Paste
                ...
                <div className="space-y-6">
                  {analysis || isLoading ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      >
                        Submit an error message to see the detailed analysis
                        here.
                      </p>
                      <button
                        onClick={() => setActiveTab("input")}
              ...
              {activeTab === "history" && (
                <HistoryDashboard
                  onSelectError={handleHistoryErrorSelect}
                  onShowQR={handleShowQR}
                />
              )}
            </div>
